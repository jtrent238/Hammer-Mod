...
public class ItemSkyTheKidRSHammer extends ItemBaseHammer {

	public ItemSkyTheKidRSHammer(ToolMaterial material, String unlocalizedName, String registryName) {
