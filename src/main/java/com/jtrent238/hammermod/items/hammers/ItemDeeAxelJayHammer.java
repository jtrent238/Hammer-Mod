...
{
    public ItemDeeAxelJayHammer(final Item.ToolMaterial a1, final String a2, final String a3) {
        super(a1, a2, a3);
    ...
    public void func_77624_a(final ItemStack a1, final World a2, final List<String> a3, final ITooltipFlag a4) {
        /*SL:20*/a3.add(ItemBaseHammer.ToolTipColor_TWITCH + "tooltip." + "hammermod" + ".twitchhammer");
    }
}
