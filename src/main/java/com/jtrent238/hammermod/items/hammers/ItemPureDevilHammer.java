...
public class ItemPureDevilHammer extends ItemBaseHammer {
	...
	public ItemPureDevilHammer(ToolMaterial material, String unlocalizedName, String registryName) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add(ItemBaseHammer.ToolTipColor_COMMUNITY_NAME + "tooltip." + Main.MODID + "." + "DevilHammer" + "." + "createdby");
